...
const Hero = () => {
  return (
    ...
    <section
      id="home"
      className="min-h-[80vh] flex flex-col justify-center pt-20 "
    >
      {/* --- HEADLINE ---
      ...
      */}
      <div className="max-w-3xl space-y-4 mb-8">
        ...
        <p className="text-base md:text-lg text-gray-500 leading-relaxed">
          From Amazon A+ content and listing images to landing pages, product
          hero visuals, and AI-powered creative production — I create digital
          experiences that help products stand out and sell.
        </p>
      </div>
